...
For the *format* of what gets emitted when the recovery rule fires, see [`writing-voice-mangle-log`](../.claude/skills/writing-voice-mangle-log/SKILL.md) in this repo. That part is public and canonical here.
